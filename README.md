...
住宅業界での営業・設計業務を経験する中で、チームの日報管理が紙やExcelで非効率なことに課題を感じていました。「実際の業務課題を解決するWebアプリを自分で作れるようになりたい」という動機から、DevStep（Web開発カリキュラム）に参加し、本プロジェクトを開発しました。
...
住宅業界での業務経験とWeb開発スキルを組み合わせ、建設・不動産業界向けのDXソリューション開発に携わりたいと考えています。
